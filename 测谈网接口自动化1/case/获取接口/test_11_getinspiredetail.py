...
def test_01_getinspiredetail_success():
...
def test_02_getinspiredetail_fail_xiaoshu():
    e_data = extool.read_excel("data/测谈网接口测试用例.xlsx", "获取灵感详情")
    url = e_data[1][2]
...
def test_03_getinspiredetail_fail_fushu():
    e_data = extool.read_excel("data/测谈网接口测试用例.xlsx", "获取灵感详情")
    url = e_data[2][2]
...
def test_04_getinspiredetail_fail_zifu():
    e_data = extool.read_excel("data/测谈网接口测试用例.xlsx", "获取灵感详情")
    url = e_data[3][2]
...
def test_05_getinspiredetail_fail_char():
    e_data = extool.read_excel("data/测谈网接口测试用例.xlsx", "获取灵感详情")
    url = e_data[4][2]
...
def test_06_getinspiredetail_fail_null():
    e_data = extool.read_excel("data/测谈网接口测试用例.xlsx", "获取灵感详情")
    url = e_data[5][2]
...
def test_07_getinspiredetail_fail_notexist():
    e_data = extool.read_excel("data/测谈网接口测试用例.xlsx", "获取灵感详情")
    url = e_data[6][2]
