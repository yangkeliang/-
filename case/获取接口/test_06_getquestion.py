...
def test_01_getquestions_success():
    e_data = extool.read_excel("data/测谈网接口测试用例.xlsx", "获取热门讨论")
    url = e_data[0][2]
...
def test_02_getquestions_noparameter():
    e_data = extool.read_excel("data/测谈网接口测试用例.xlsx", "获取热门讨论")
    url = e_data[1][2]
...
def test_03_getquestions_paraxiaoshu():
    e_data = extool.read_excel("data/测谈网接口测试用例.xlsx", "获取热门讨论")
    url = e_data[2][2]
...
def test_04_getquestions_parachar():
    e_data = extool.read_excel("data/测谈网接口测试用例.xlsx", "获取热门讨论")
    url = e_data[3][2]
...
def test_05_getquestions_parafushu():
    e_data = extool.read_excel("data/测谈网接口测试用例.xlsx", "获取热门讨论")
    url = e_data[4][2]
...
def test_06_getquestions_paranotexist():
    e_data = extool.read_excel("data/测谈网接口测试用例.xlsx", "获取热门讨论")
    url = e_data[5][2]
