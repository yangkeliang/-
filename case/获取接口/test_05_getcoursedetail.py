...
def test_01_getcoursedetail_success():
    e_data = extool.read_excel("data/测谈网接口测试用例.xlsx", "获取教程详情")
    url = e_data[0][2]
...
def test_02_getcoursedetail_fail_xiaoshu():
    e_data = extool.read_excel("data/测谈网接口测试用例.xlsx", "获取教程详情")
    url = e_data[1][2]
...
def test_03_getcoursedetail_fail_fushu():
    e_data = extool.read_excel("data/测谈网接口测试用例.xlsx", "获取教程详情")
    url = e_data[2][2]
...
def test_04_getcoursedetail_fail_zifu():
    e_data = extool.read_excel("data/测谈网接口测试用例.xlsx", "获取教程详情")
    url = e_data[3][2]
...
def test_05_getcoursedetail_fail_char():
    e_data = extool.read_excel("data/测谈网接口测试用例.xlsx", "获取教程详情")
    url = e_data[4][2]
...
def test_06_getcoursedetail_fail_null():
    e_data = extool.read_excel("data/测谈网接口测试用例.xlsx", "获取教程详情")
    url = e_data[5][2]
...
def test_07_getcoursedetail_fail_notexist():
    e_data = extool.read_excel("data/测谈网接口测试用例.xlsx", "获取教程详情")
    url = e_data[6][2]
